...
- **Our frames vs. python:** SDO expedited download (U32/U8/I16), upload
  ...
  toggle / last / unused-byte bits); NMT node-control commands; EMCY; SYNC; and
  the PDO mapping-value format.
...
All 21 checks currently pass. This validates the **wire format**; it does not
